function AboutOrderOnPDP() {
    return (
        <div className="MuiGrid-root MuiGrid-container mui-style-1v9bsgw mui-style-1ukk5qr aboutorder-pdp">
            <div className="MuiGrid-root MuiGrid-item aboutorder-pdp-item mui-style-adz23w MuiGrid-grid-mobile-12 MuiGrid-grid-tablet-6 MuiGrid-grid-desktop-3 mui-style-1sx9kvq">
                <div className="MuiBox-root mui-style-0">
                    <div className="MuiBox-root mui-style-1g4mq4g">
                        <p className="MuiTypography-root MuiTypography-h6 mui-style-1e2a067">0</p>
            ...
            <div className="MuiGrid-root MuiGrid-item  aboutorder-pdp-item MuiGrid-grid-mobile-12 MuiGrid-grid-tablet-6 MuiGrid-grid-desktop-3 mui-style-adz23w">
                <div className="MuiBox-root mui-style-0">
                    <div className="MuiBox-root mui-style-1g4mq4g">
                        <p className="MuiTypography-root MuiTypography-h6 mui-style-1e2a067">0</p>
...
export default AboutOrderOnPDP;